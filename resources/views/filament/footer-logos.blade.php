<div style="display: flex; align-items: center; justify-content: flex-end; gap: 0.5rem; padding-top: 1rem; margin-top: 3rem; border-top: 1px solid #e5e7eb; opacity: 0.8;">
    <img src="{{ asset('images/coahuila.png') }}" alt="Coahuila" style="height: 3.6rem; width: auto; object-fit: contain;" />
