...
- **Conducta suicida (ASQ)**: los 4 ítems 0/1 puntúan; la **pregunta 5** ("¿Estás pensando en quitarte la vida en este momento?") solo se despliega si hubo algún "Sí" y es la **única** que establece `Riesgo Agudo`. Un "Sí" en la 4 despliega además "¿Cuándo fue el último intento?" (menos/más de 12 meses), que es informativa: se guarda en `respuestas['conducta_suicida']['ultimo_intento']` y no altera la clasificación.
