        ...
        return $panel
            ...
            ->renderHook(
                ...
                fn (): string => \Illuminate\Support\Facades\Blade::render('<style>
                    ...
                    .fi-resource-create-record-page form, .fi-resource-edit-record-page form, .fi-custom-profile-page form { background-color: #ffffff !important; padding: 2rem !important; border-radius: 0.75rem !important; box-shadow: 0 0px 10px 0px var(--tw-shadow-color, #eee), 0 0px 10px 1px var(--tw-shadow-color, #eee) !important; }
                    ...
                    .fi-resource-create-record-page form .fi-ac, .fi-resource-edit-record-page form .fi-ac, .fi-custom-profile-page form .fi-ac { display: flex !important; flex-direction: row-reverse !important; justify-content: flex-start !important; gap: 1rem !important; flex-wrap: wrap !important; }
                    .fi-resource-create-record-page form .fi-btn, .fi-resource-edit-record-page form .fi-btn, .fi-custom-profile-page form .fi-btn { padding: 0.75rem 2rem !important; height: auto !important; border-radius: 0.5rem !important; margin: 0 !important; }
                    .fi-resource-create-record-page form .fi-btn.fi-color-gray, .fi-resource-edit-record-page form .fi-btn.fi-color-gray, .fi-resource-create-record-page form .fi-btn-color-gray, .fi-resource-edit-record-page form .fi-btn-color-gray, .fi-resource-create-record-page form .fi-btn:not(.fi-color-primary):not(.fi-color-custom), .fi-resource-edit-record-page form .fi-btn:not(.fi-color-primary):not(.fi-color-custom), .fi-custom-profile-page form .fi-btn.fi-color-gray, .fi-custom-profile-page form .fi-btn-color-gray, .fi-custom-profile-page form .fi-btn:not(.fi-color-primary):not(.fi-color-custom) { background-color: #f3f4f6 !important; color: #4b5563 !important; border: none !important; box-shadow: none !important; ring: none !important; }
                    .fi-resource-create-record-page form .fi-btn.fi-color-gray:hover, .fi-resource-edit-record-page form .fi-btn.fi-color-gray:hover, .fi-resource-create-record-page form .fi-btn-color-gray:hover, .fi-resource-edit-record-page form .fi-btn-color-gray:hover, .fi-resource-create-record-page form .fi-btn:not(.fi-color-primary):not(.fi-color-custom):hover, .fi-resource-edit-record-page form .fi-btn:not(.fi-color-primary):not(.fi-color-custom):hover, .fi-custom-profile-page form .fi-btn.fi-color-gray:hover, .fi-custom-profile-page form .fi-btn-color-gray:hover, .fi-custom-profile-page form .fi-btn:not(.fi-color-primary):not(.fi-color-custom):hover { background-color: #e5e7eb !important; color: #374151 !important; }
                    .fi-resource-create-record-page form .fi-btn.fi-color-gray *, .fi-resource-edit-record-page form .fi-btn.fi-color-gray *, .fi-resource-create-record-page form .fi-btn-color-gray *, .fi-resource-edit-record-page form .fi-btn-color-gray *, .fi-resource-create-record-page form .fi-btn:not(.fi-color-primary):not(.fi-color-custom) *, .fi-resource-edit-record-page form .fi-btn:not(.fi-color-primary):not(.fi-color-custom) *, .fi-custom-profile-page form .fi-btn.fi-color-gray *, .fi-custom-profile-page form .fi-btn-color-gray *, .fi-custom-profile-page form .fi-btn:not(.fi-color-primary):not(.fi-color-custom) * { color: #4b5563 !important; }
                    .fi-resource-create-record-page form .fi-btn.fi-outlined, .fi-resource-edit-record-page form .fi-btn.fi-outlined, .fi-custom-profile-page form .fi-btn.fi-outlined { box-shadow: none !important; border: none !important; }
