...
class ConfiguradorLanding extends Page implements HasForms
{
    ...
    {
        // `resultados_tamizaje_visibles` va explícito y no por el default de la
        // columna: en una fila recién creada el atributo no vendría cargado y el
        // toggle aparecería apagado sin que nadie lo apagara.
        $globalConfig = Setting::firstOrCreate(
            ['key' => 'global_config'],
            ['herramientas_empresa_activas' => false, 'resultados_tamizaje_visibles' => true]
        );
        ...
        $this->form->fill([
            ...
            'resultados_tamizaje_visibles' => (bool) $globalConfig->resultados_tamizaje_visibles,
        ]);
    }
    ...
    public function form(Schema $form): Schema
    {
        return $form
            ->schema([
                Section::make('Apariencia Pública')
                ...
                Section::make('Sección de Crisis')
    ...
    public function save(): void
    {
        ...
        Setting::updateOrCreate(
            ...
            [
                ...
                'resultados_tamizaje_visibles' => (bool) ($data['resultados_tamizaje_visibles'] ?? false),
            ]
        );
